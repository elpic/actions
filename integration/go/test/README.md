...
Your project needs a task named `test:coverage` that produces `coverage.out`. Coverage from the main branch is downloaded via `gh run download` and compared against the current PR.
